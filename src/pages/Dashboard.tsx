          ...
          >
            ...
            {entries?.map((entry, index) => (
              ...
              >
                ...
                {/* Content card */}
                <Card className="ml-6 md:ml-0 md:w-[45%] hover:shadow-lg transition-all duration-300 cursor-pointer backdrop-blur-lg bg-white/5 border border-white/10 rounded-2xl group-hover:scale-[1.02]">

...
export const Navigation = () => {
  ...
  return <div className="fixed bottom-0 left-0 right-0 p-4 z-40 px-[8px]">
      <nav className="max-w-screen-sm mx-auto rounded-full p-2 bg-zinc-900/40 backdrop-blur-md border border-white/5">
        <div className="flex justify-center items-center gap-2">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" className={cn("flex-1 max-w-[140px] gap-2 transition-all duration-300 scale-105 rainbow-border hover:bg-transparent", isActive("/new") && "scale-110")} asChild>
                <Link to="/new">
